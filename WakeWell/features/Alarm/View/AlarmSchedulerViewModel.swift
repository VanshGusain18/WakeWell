...
final class AlarmSchedulerViewModel {
    ...
    private func registerNotificationCategory() {
        let stop  = UNNotificationAction(identifier: "STOP_ALARM",    title: "Stop Alarm",            options: [.foreground])
        let start = UNNotificationAction(identifier: "START_RITUAL",  title: "▶ Start Morning Ritual", options: [.foreground])
