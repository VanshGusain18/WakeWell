...
class EfficiencyTableViewController: BaseMetricTableViewController {

    private var data: [EfficiencyData] = []
    ...
    override func buildCell(for section: SectionType, range: StatsTimeRange,
        ...
        case .header:
            ...
            cell.configure(
                title: "Efficiency",
                description: "How much of your time in bed is actually spent sleeping."
            )
            return cell

        case .trend:
            let cell = dequeueLineChart(tableView, indexPath: indexPath)
            let chartData = EfficiencyAnalyzer.trendChartData(from: data)
        ...
        case .fragmentation:
            ...
            let chartData = EfficiencyAnalyzer.breakdownChartData(from: data)
            cell.configure(title: chartData.title,
                           dataSets: chartData.dataSets,
                           xAxisLabels: chartData.xAxisLabels)
            return cell
        ...
        case .info:
            ...
            cell.configure(title: "About Sleep Efficiency",
                           description: EfficiencyAnalyzer.efficiencyInfo())
            return cell
        }
    }
