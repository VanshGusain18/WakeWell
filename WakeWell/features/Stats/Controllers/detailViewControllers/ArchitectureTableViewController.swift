...
class ArchitectureTableViewController: BaseMetricTableViewController {

    private var data: [SleepArchitectureData] = []
    ...
    override func buildCell(for section: SectionType, range: StatsTimeRange,
        ...
        case .trend:
            ...
            let chartData = SleepArchitectureAnalyzer.trendChartData(from: data)
        ...
        case .fragmentation:
            ...
            let chartData = SleepArchitectureAnalyzer.distributionChartData(from: data)
            cell.configure(title: chartData.title,
                           dataSets: chartData.dataSets,
                           xAxisLabels: chartData.xAxisLabels)
            return cell
        ...
        case .info:
            ...
            cell.configure(title: "About Sleep Architecture",
                           description: SleepArchitectureAnalyzer.architectureInfo())
            return cell
        }
    }
